...
\begin{wrapfigure}{r}{8em}
  \flushright
  \includegraphics[scale=0.4]{profile_small_crop} 
\end{wrapfigure}
...
E-mail: \href{mailto:simonzsoltjota@gmail.com}{simonzsoltjota@gmail.com}\\
...
\begin{itemize}
  \item{
    2018-tól: Fullstack fejlesztő RisingStack Kft.-nél.
  }
  \item{ 
...
\begin{itemize}
  \item{2020: Eötvös Loránd Tudományegyetem Bölcsésztudományi Kar Reneszánsz Tanulmányok mesterszak}
...
Szakmai ismeretek
  ...
  \begin{itemize}
    \item{Javascript: ES6, Node.js, Angular, ReactJS}
    \item{SQL és NoSQL adatbázisok: MariaDB, SQL Server, 
      MongoDB, OrientDB, ArangoDB, Elasticsearch, Neo4j}
    \item{Git, JIRA, Jenkins, Shell, Docker}
    \item{UNIX-típusú rendszrek ismerete}
    \item{PHP, Perl, \LaTeX, Python}
    \item{AWS, Heroku, OpenShift, Kubernetes}
  \end{itemize}
